...
class WPUnitTest extends TestCase
{
	...
	public function testFindConnections() {
		...
		$connection = $this->client->getRelation( RELATION_NAME )->createConnection( $connection_query );

		// Find the connection by ID.
		$find_query = new Connection();
		$find_query->id = $connection->id;

		$found_connections = $this->client->getRelation( RELATION_NAME )->findConnections( $find_query );
	...
	public function testRestUpdateMeta() {
		...
		$request->set_param( 'relation', RELATION_NAME );
